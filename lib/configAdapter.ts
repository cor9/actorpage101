...
export function adaptNewConfigToOld(
  ...
  return {
    ...
    hero: {
      ...
      ageRange: props.profile.ageRange || undefined,
      location: props.profile.location || undefined,
      brandLine: props.profile.tagline || undefined,
      castingType: props.profile.bio || undefined,
      unionStatus: props.profile.unionStatus || undefined,
